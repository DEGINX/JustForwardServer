package com.nanokylin.justforwardserver.utils;

import com.nanokylin.justforwardserver.JustForwardServer;
...
public class FileUtil {
    ...
    public void copyFileOutOfJar(String path, String outPath) {
        InputStream is = JustForwardServer.class.getResourceAsStream(path);
